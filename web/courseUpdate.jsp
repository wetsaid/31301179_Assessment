            ...
            <div class="xs">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="horizontal-form">
                        ...
                        <form action="course!updateCourse.action" method="post" name="form" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="course.courseName" value="${course.courseName}" type="text"
                                           class="form-control1">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="course.courseTime" value="${course.courseTime}" type="text"
                                           class="form-control1">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="course.courseLocation" value="${course.courseLocation}" type="text"
                                           class="form-control1">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="course.courseCapacity" value="${course.courseCapacity}" type="text"
                                           value="70" class="form-control1">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">起始周</label>
                                <div class="col-sm-8">
                                    <input name="startWeek" readonly value="${start}" type="text" value="1"
                                           class="form-control1">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="endWeek" readonly value="${end}" type="text" value="17"
                                           class="form-control1">
                                </div>
                            </div>
                            <div class="panel-footer">
                                <div class="row">
                                    <div class="col-sm-8 col-sm-offset-2">
                                        <input class="btn-success btn" type="submit" value="修改">
