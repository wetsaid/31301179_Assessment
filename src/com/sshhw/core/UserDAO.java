...
public class UserDAO {
	...
	public List<User> findByExample(User instance) {
		...
		try {
			List<User> results = (List<User>) getCurrentSession()
					.createCriteria("com.sshhw.core.User")
	...
	public List<User> findByAgname(Object agname) {
		return findByProperty(AGNAME, agname);
	}

	public List<User> findByScore(Object score) {
